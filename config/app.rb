Volt.configure do |config|
  ...
  #######################################
  config.domain = 'toodo.com'
  config.app_name = 'Toodo'
  config.mailer.from = 'Toodo <no-reply@toodo.com>'
  ...
  #
  config.app_secret = 'XBYWEE5mz63zXB6nVr2QLLmSP5f0cCT8vV4h9_aSW7m64JjEbp0qf3kL1vCGZ_OzO5g'
